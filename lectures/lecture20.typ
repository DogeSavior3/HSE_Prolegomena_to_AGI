...
Во втором случае происходит обратный эффект. Для борьбы с этими двумя ситуациями было предложено два подхода. Первый носит название Ложных ближайших соседей (FNN, false nearest neighbours), второе ложных ближайших соседей на складах (FNF, false nearest neighbours on folds). 
...
#canvas( length: 2cm, {
    ...
    plot.plot(size: (3,3),
          ...
          plot.add(drop, domain: (0, 0.7), style: (stroke: (paint: black)))
          plot.add(two, domain: (0.7, 4), style: (stroke: (paint: black)))
})
...
Очевидно, что у нас выполнены условия теоремы Таккенса, с другой стороны от ситуации с ложными соседями на складах мы далеки. 
