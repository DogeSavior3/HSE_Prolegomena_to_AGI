...
с теми оценками, которые мы получили движением по графику $K S$ от $x_min.$ 

Мы берем некоторое степенное распределение, и порождаем выборки. У нас есть много выборок. Для каждой выборки мы считаем $K S$, в том числе для исходной (обрезав $x_min$).

 В подавляющем большинстве случаев, значение $K S$ для нашей выборки будет больше, чем для синтетических выборок, которые мы сделали таким образом, чтобы они были максимально близки к нашему реальному распределению.
